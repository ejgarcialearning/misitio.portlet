...
class IExamplePortlet(IPortletDataProvider):
    ...
    some_field = schema.TextLine(title=_(u"Usuario"),
                                  description=_(u"Nombre del Usuario"),
                                  required=True)
    asuntocorreo = schema.TextLine(title=_(u"Asunto"),
                                  description=_(u"Asunto del tema"),
                                  required=True)
...
class Assignment(base.Assignment):
    ...
    def __init__(self, some_field=u"",asuntocorreo=u""):
